...
<head>
    ...
    <title>CapsulCast - خطای ۴۰۴</title>
...
<body dir="rtl">
    ...
    <main class="main">
        ...
        <div class="site-breadcrumb" style="background: url(images/aboutus-01.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">خطای ۴۰۴</h2>
            ...
            <div class="container">
                <div class="col-md-6 mx-auto">
                    <div class="error-wrapper">
                        ...
                        <h2>اوپسسسس... صفحه یافت نشد!</h2>
                        <p>ممکن است صفحه ای که به دنبال یافت نشد وجود نداشته باشد یا حذف شده باشد.</p>
                        <a href="index-2.html" class="theme-btn">برگشت به خانه <i class="far fa-home"></i></a>
                    </div>
                </div>
            </div>
        </div>
